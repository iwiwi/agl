...
def residual_by_k():
    ...
    residuals = {
        "(3, 0, 6)-SHM": np.array([1.01303547911,
                                   1.01395349842,
                                   1.01143661609,
                                   1.00769589824,
                                   1.00539704767,
                                   1.00389170897,
                                   1.0,]),
        "(3, 3, 7)-flower": np.array([1.19903705818,
                                      1.19060581606,
                                      1.23245792876,
                                      1.20965716564,
                                      1.18548440066,
                                      1.17346469622,
                                      1.18185550082,]),
        "(2, 0, 8)-SHM": np.array([1.03668893673,
                                   1.05144652459,
                                   1.04971979683,
                                   1.05271868918,
                                   1.04560075041,
    ...
    error_bar = {
        "(3, 0, 6)-SHM": np.array([0.0216637613746,
                                   0.0335390685564,
                                   0.020514163035,
                                   0.0138057874779,
                                   0.0122831496339,
                                   0.00900290057152,
                                   0.0,]),
        "(3, 3, 7)-flower": np.array([0.228632301028,
                                      0.198255216953,
                                      0.257758024212,
                                      0.252781424154,
                                      0.214752879588,
                                      0.188521640451,
                                      0.229089666098,]),
        "(2, 0, 8)-SHM": np.array([0.0570556230701,
                                   0.0768943364425,
                                   0.0677197822587,
                                   0.0719465259731,
                                   0.0707007343681,
...
def residual_by_p():
    ...
    residuals = {
        "(3, 0, 6)-SHM": np.array([1.0105565343,
                                   1.01015447279,
                                   1.01079628386,
                                   1.00769589824,
                                   1.00769589824,
                                   1.00769589824,
                                   1.00402298851,]),
        "(3, 3, 7)-flower": np.array([1.22280614666,
                                      1.21983349956,
                                      1.20166263276,
                                      1.20965716564,
                                      1.18612479475,
                                      1.22044334975,
                                      1.21425287356,]),
        "(2, 0, 8)-SHM": np.array([1.05126241841,
                                   1.05453650188,
                                   1.05550689904,
                                   1.05271868918,
                                   1.04906607577,
    ...
    error_bar = {
        "(3, 0, 6)-SHM": np.array([0.0170628162736,
                                   0.0172689991427,
                                   0.017231431309,
                                   0.0138057874779,
                                   0.0138057874779,
                                   0.0138057874779,
                                   0.0142059851659,]),
        "(3, 3, 7)-flower": np.array([0.221603380899,
                                      0.249952625884,
                                      0.240899171061,
                                      0.252781424154,
                                      0.222364532626,
                                      0.264948594074,
                                      0.259088458563,]),
        "(2, 0, 8)-SHM": np.array([0.0670298119502,
                                   0.0692714620566,
                                   0.0740803576669,
                                   0.0719465259731,
                                   0.0703512166304,
    ...
    for x in xrange(0, 2):
        ...
        for graph_name in keys:
            (_, caps, _) = axes.errorbar(k * displace[graph_name],
                                         residuals[graph_name],
                                         yerr=[
                                             error_bar[graph_name],
                                             error_bar[graph_name],
                                         ],
